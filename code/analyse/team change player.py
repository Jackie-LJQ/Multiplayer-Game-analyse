...
"""
find team performance vs how frequently they change their player.
using average score on matches represents team performance.
...
dfplayer = pd.read_csv('F:\grid\data\player_team_Date.csv')
...
average = average[np.abs(stats.zscore(average['Team Score'])) < 2]
